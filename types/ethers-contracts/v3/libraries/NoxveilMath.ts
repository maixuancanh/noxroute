...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../common.js"
  ...
  export interface NoxveilMathInterface extends Interface {
  ...
  export interface NoxveilMath extends BaseContract {
    
    connect(runner?: ContractRunner | null): NoxveilMath;
    waitForDeployment(): Promise<this>;

    interface: NoxveilMathInterface;
