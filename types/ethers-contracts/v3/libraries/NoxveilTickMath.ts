...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../common.js"
  ...
  export interface NoxveilTickMathInterface extends Interface {
  ...
  export interface NoxveilTickMath extends BaseContract {
    
    connect(runner?: ContractRunner | null): NoxveilTickMath;
    waitForDeployment(): Promise<this>;

    interface: NoxveilTickMathInterface;
