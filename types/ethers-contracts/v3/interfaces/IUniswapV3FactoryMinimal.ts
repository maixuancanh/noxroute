...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IUniswapV3FactoryMinimalInterface extends Interface {
  ...
  export interface IUniswapV3FactoryMinimal extends BaseContract {
    
    connect(runner?: ContractRunner | null): IUniswapV3FactoryMinimal;
    waitForDeployment(): Promise<this>;

    interface: IUniswapV3FactoryMinimalInterface;
