...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface MockERC20DecimalsInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  export interface MockERC20Decimals extends BaseContract {
    
    connect(runner?: ContractRunner | null): MockERC20Decimals;
    waitForDeployment(): Promise<this>;

    interface: MockERC20DecimalsInterface;
